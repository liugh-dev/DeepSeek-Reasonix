...
var ChineseTraditional = Messages{
	...
	ResumePickHint:      "↑/↓ 移動 · Enter 恢復 · x 刪除 · Esc 取消",
	ResumePickCannotDeleteActive: "無法刪除目前正在使用的會話",
	ResumePickDeletedFmt: "已刪除會話 %s",
	ResumePickDeleteFailedFmt: "刪除失敗：%v",
	...
	StatusResumePicker:          "↑/↓ 移動 · Enter 恢復 · x 刪除 · Esc 取消",
	AskSubmitTitle:              "提交答案",
	AskUnanswered:               "(未答)",
...
`,
	...
	SlashClearPrompt:           "清空當前上下文（會儲存之前的會話）？",
	SlashClearDone:             "已清空當前上下文 — 之前的對話已存檔",
	SlashClearFailed:           "清空當前上下文失敗",
	CmdClear:                   "與 /new 等價：清屏並儲存歷史",
	CmdRename:                  "重新命名會話",
	CmdGoal:                    "設定或清除當前目標",
