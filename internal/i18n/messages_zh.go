...
var Chinese = Messages{
	...
	ResumePickHint:               "↑/↓ 移动 · Enter 恢复 · x 删除 · Esc 取消",
	ResumePickCannotDeleteActive: "无法删除当前正在使用的会话",
	ResumePickDeletedFmt:         "已删除会话 %s",
	ResumePickDeleteFailedFmt:    "删除失败：%v",
	...
	StatusResumePicker:          "↑/↓ 移动 · Enter 恢复 · x 删除 · Esc 取消",
	AskSubmitTitle:              "提交答案",
	AskUnanswered:               "(未答)",
	...
	SlashClearPrompt:   "清空当前上下文（会保存之前的会话）？",
	SlashClearDone:     "已清空当前上下文 — 之前的对话已存档",
