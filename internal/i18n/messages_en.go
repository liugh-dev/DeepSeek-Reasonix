...
var English = Messages{
	...
	ResumePickHint:               "↑/↓ move · Enter resume · x delete · Esc cancel",
	ResumePickCannotDeleteActive: "can't delete the session you're in",
	ResumePickDeletedFmt:         "deleted session %s",
	ResumePickDeleteFailedFmt:    "delete failed: %v",
	...
	StatusResumePicker:          "↑/↓ move · Enter resume · x delete · Esc cancel",
	...
	SlashClearPrompt:   "Clear current context (saves the previous session)?",
	SlashClearDone:     "context cleared — previous transcript saved",
	...
	CmdNew:              "start a new session (saves the previous one)",
	CmdClear:            "alias for /new: clear display, save transcript",
