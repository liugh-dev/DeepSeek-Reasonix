...
type ProviderEntry struct {
	...
	ContextWindows map[string]int               `toml:"context_windows"` // optional per-model overrides; unlisted models fall back to ContextWindow. An explicit 0 disables compaction for that model.
