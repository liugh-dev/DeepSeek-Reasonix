...
export const en = {
  ...
  "caps.reportedReadOnlyTitle": "This MCP server reports readOnlyHint; Reasonix asks once when planning needs it, or you can pre-trust it here",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from Reasonix presets for DeepSeek.",
  ...
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a Reasonix restart.",
